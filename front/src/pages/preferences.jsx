...
export default function Preferences() {
    ...
    const onClick = async () => {
        try {
            ...
            setPreferences("");
            toast.success("Contre-indication alimentaire ajoutée !");
            await getUserInfo();
        } catch (err) {
            toast.error(
                "Erreur lors de l'ajout de la contre-indication alimentaire !"
            );
        }
    };
            ...
            <DefaultLayout>
                ...
                <div className="flex items-center my-16 relative ">
                    <div className="container p-2 mx-auto sm:p-4 dark:text-gray-800">
                        ...
                        <p>
                            Si vous avez des restrictions alimentaires telles
                            que des allergies, des contre-indications médicales,
                            des motifs religieux, etc., veuillez les saisir ici.
                            Cela nous permettra de restreindre les résultats de
                            recherche pour correspondre à vos besoins
                            spécifiques.
                        </p>
                        <br />
