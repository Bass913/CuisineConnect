      ...
      <div className="w-128 bg-white rounded-md shadow-md p-10 relative">
        ...
        <div className="flex justify-center mt-5 gap-5">
          {buttonsToShow.includes("email") && (
            <Button
              onClick={() => {
                const emailSubject = encodeURIComponent("Ma liste de courses");
                const emailBody = encodeURIComponent(shoppingListText);
            ...
            <Button
              onClick={() => {
                navigator.clipboard.writeText(shoppingListText).then(
                  () => {
                    toast("Liste de courses copiée dans le presse-papier !", {
                      position: "top-right",
                      autoClose: 5000,
                      color: "red",
                  ...
                  () => {
                    toast("Erreur lors de la copie dans le presse-papier", {
                      position: "top-right",
                      autoClose: 5000,
                      color: "red",
                      hideProgressBar: false,
            ...
            <Button
              onClick={() => {
                const tweetText = encodeURIComponent(
                  "Découvrez ma liste de courses ! " + shoppingListText
                );
